...
- [research/nghien-cuu-repo-tham-khao.md](research/nghien-cuu-repo-tham-khao.md) — kho link repo tham khảo (một nơi duy nhất, có bảng): CI-CD-Beginner (đã áp dụng pin SHA + least-privilege; danh sách chờ giai đoạn CD; mục đã loại kèm điều kiện xem lại) + mattpocock/skills (chi tiết ở doc riêng) + ui-ux-pro-max-skill (đã tích hợp v2.13.0 vào `.claude/skills/`, kèm 3 lưu ý khi cập nhật)
