...
- [research/nghien-cuu-cicd-tham-khao.md](research/nghien-cuu-cicd-tham-khao.md) — kho repo CI/CD tham khảo (CI-CD-Beginner 07/08/2026): đã áp dụng pin SHA + least-privilege permissions; danh sách chờ giai đoạn CD (Environment approval, smoke test, Ruleset JSON, GHCR+SSH) và mục đã loại kèm điều kiện xem lại (cosign/SLSA, multi-arch)
