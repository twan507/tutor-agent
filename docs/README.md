...
- [research/nghien-cuu-skills-mattpocock.md](research/nghien-cuu-skills-mattpocock.md) — khảo sát repo skills của Matt Pocock 05/08/2026: 5 kỹ thuật đã nhận vào harness (CONTEXT.md glossary, grilling frontier, debug kỷ luật, review hai trục, cắt tỉa tài liệu) + 4 nhóm bị loại kèm lý do và điều kiện xem lại; rà lại 07/08: nhận thêm quy tắc redact secret trong output debug
...
- [research/nghien-cuu-repo-tham-khao.md](research/nghien-cuu-repo-tham-khao.md) — kho repo tham khảo (một nơi duy nhất), tách 2 mục: (A) skill đã tích hợp vào `.claude/skills/` — ui-ux-pro-max v2.13.0, react-best-practices v1.0.0, kèm lưu ý cập nhật; (B) repo tham khảo kiến thức — CI-CD-Beginner, mattpocock/skills, graphify (chờ), addyosmani security-auditor (chờ); cuối doc là danh sách đã khảo sát-và-loại kèm lý do
...
- [plans/2026-08-07-bo-icon-tabler-plan.md](plans/2026-08-07-bo-icon-tabler-plan.md) — plan 7 task cho bộ icon Tabler: manifest, rule mức manifest (TDD), generator (TDD), checker đọc manifest, sinh 220 file, giấy phép + tài liệu, review (TRẠNG THÁI: đã thực thi 07/08/2026)
