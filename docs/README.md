...
- [specs/2026-08-05-lenh-chay-du-an.md](specs/2026-08-05-lenh-chay-du-an.md) — spec bộ 5 lệnh chạy dự án thay Makefile: dev-start/dev-stop/docker-up/docker-down/docker-clean, ma trận tác động, ranh giới dữ liệu (TRẠNG THÁI: đã duyệt, đang thực thi)
...
- [plans/2026-08-05-lenh-chay-du-an-plan.md](plans/2026-08-05-lenh-chay-du-an-plan.md) — plan 3 task: script lõi + lệnh docker, dev-start/dev-stop hot-reload, tài liệu + verify (TRẠNG THÁI: đang thực thi)
