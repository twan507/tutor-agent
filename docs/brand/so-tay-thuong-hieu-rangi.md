...
### 1.1 Tại sao cái tên này tồn tại

Trước Rangi, dự án mang tên **Flibby** — sản phẩm của 10 vòng brainstorm. Flibby sạch về pháp lý tại Việt Nam nhưng có ba vết: cụm phụ âm đầu "fl-" nằm trong danh sách tránh (người Việt đọc "phờ-li" mất một nhịp), trông trẻ con, và va chạm quốc tế với Flibbo (app AI ở Dubai). Người dùng "chưa thích lắm" — cảm giác đó được xác nhận bằng số khi tái chấm điểm khách quan: Flibby chỉ đạt 19/30, nằm giữa bảng.

Vòng 11 sinh 14 ứng viên mới, tra cứu kỹ 6, và Rangi thắng với **24/30** — điểm cao nhất trong toàn bộ 11 vòng.

### 1.2 Ba tầng nghĩa của "RANG"
...
Rangi là tên **thần Bầu Trời trong thần thoại Māori** (New Zealand) — người cha trời tách khỏi đất mẹ Papa **để ánh sáng lọt vào thế gian**. Trớ trêu đẹp: tra cứu để tránh trùng tên lại tìm ra một tích cũng về ánh sáng. Dùng làm chuyện kể phụ khi giới thiệu ở thị trường nói tiếng Anh; **không dùng ở thị trường Việt** (xa lạ, làm loãng ba tầng nghĩa tiếng Việt vốn mạnh hơn nhiều).

### 1.5 Vì sao cái tên này "sạch" — và vì sao điều đó đáng tiền

Sau 11 vòng tra cứu, Rangi là tên **duy nhất không đụng bất kỳ công ty, app hay sản phẩm giáo dục nào** ở cả Việt Nam lẫn quốc tế. Đối chiếu: Lango đụng cả cụm AI language tutor; Lumify bị tập đoàn NYSE giữ với 4 bằng sáng chế; Vela đụng cả trung tâm tiếng Anh ở VN lẫn app giáo dục Mỹ; Compa là danh từ chung (không bảo hộ nổi, SEO đấu với nhà sách bán compa thật).

Giá trị thực tế của "sạch": mua được domain, đứng đầu kết quả tìm kiếm tên mình, đăng ký được nhãn hiệu, và không bao giờ bị nhầm với ai. Với founder bootstrap, đây là ba khoản tiết kiệm lớn.

⚠️ **Việc chặn còn lại**: tra nhãn hiệu chính thức tại Cục SHTT nhóm 41 (giáo dục) + 9/42 (phần mềm). Tra cứu hiện tại mới là hiện diện công khai. Việt Nam theo nguyên tắc **ai nộp trước được ưu tiên** — càng sớm càng tốt, nhất là khi repo và tên đã public.
...
### Hướng 2 — Rạng danh (đòn bẩy cảm xúc với người trả tiền)

Không bao giờ nói thẳng chữ "rạng danh" (nghe cũ và áp lực), nhưng **khai thác vùng cảm xúc đó**: khoảnh khắc phụ huynh khoe kết quả của con, tin nhắn báo con vừa vượt qua chương khó. Dùng cho: testimonial, case study before/after, nội dung nhắm phụ huynh trên Facebook.

⚠️ Ranh giới: không được biến thành áp lực thành tích hay so sánh "con nhà người ta" — mâu thuẫn trực tiếp với triết lý và với ràng buộc pháp lý về notification.
...
### Hướng 4 — Ký ức đom đóm của thế hệ 8x-9x (nội dung chạm tim)
...
Khai thác chữ "i" để nói về **bước nhỏ**: "bắt đầu lại từ i tờ cũng không sao", "mỗi tối một chữ i". Chống lại nỗi sợ của phụ huynh rằng AI là thứ cao siêu, đắt đỏ, con mình theo không nổi. Dùng cho: nội dung onboarding, FAQ, bài viết dành cho phụ huynh còn e ngại công nghệ.
...
### Hướng 7 — Cái tên ngắn, dễ đọc, dễ truyền miệng

Hai âm tiết mở, không cụm phụ âm khó. Phụ huynh nghe một lần là gọi đúng, nhắn tin cho nhau không sai chính tả. Với sản phẩm mà **kênh rẻ nhất là truyền miệng trong hội nhóm phụ huynh**, đây là tài sản thật chứ không phải chi tiết thẩm mỹ.

---

## 3. Mascot: con đom đóm
...
### 3.2 Quy tắc cảm xúc: theo Forest, KHÔNG theo Duolingo

Nghiên cứu xác nhận Duolingo **cố ý** làm mascot hơi đáng sợ và dùng cảm giác tội lỗi (mất streak) để kéo người dùng quay lại — hiệu quả cho app học ngôn ngữ người lớn, nhưng với Rangi thì đó là **thứ phải né**, vì hai lý do:

1. **Pháp lý**: mascot tạo cảm giác bị theo dõi hoặc trừng phạt sẽ đẩy sản phẩm vào mục 3 Danh mục AI rủi ro cao (giám sát, phân tích hành vi người học gây căng thẳng tâm lý)
...
**Hổ phách `#F5A623`** và **ngọc lục bảo `#0E7A5A`**. Cặp này do người sáng lập tự đề xuất, và nó đắt hơn phương án ban đầu của nghiên cứu (hổ phách + navy) vì hai lý do phát hiện sau đó:
...
Xanh dương và xanh lá đã bão hòa (VioEdu, Vuihoc, ELSA, Ruangguru, Duolingo). Cam/vàng chỉ xuất hiện làm màu phụ — **chưa ai lấy làm màu chủ đạo**. Điều kiện để giữ khoảng trống: đi **lục bảo sâu** (jewel tone ngả lam), tránh xa vùng lục non/lime của Duolingo `#58CC02`.
...
Nghiên cứu peer-reviewed đúng đối tượng (**Merrick & Fyfe 2023**, trẻ em giải Toán với phản hồi đúng/sai): cảm xúc tiêu cực sau câu sai là **có thật** và ảnh hưởng tới độ kiên trì — nhưng thủ phạm là **mức độ "phán xét" của tổng thể phản hồi** (dấu X to, giọng điệu, có được sửa lại không), **không phải bản thân màu đỏ**.

Kết luận áp dụng: dùng **đỏ thật** (nhận diện tức thời, đúng kỳ vọng của trẻ) nhưng **sự nhẹ nhàng nằm ở câu chữ và cơ chế**: "Chưa đúng — thử lại nhé", cho làm lại, không trừ điểm nặng. Sắc độ chọn L50 mềm hơn đỏ báo động.

Bắt buộc kèm: đúng/sai **luôn có icon ✓/✗**, vì người mù màu đỏ-lục không phân biệt được hai màu này.

---

## 5. Chữ: vì sao PhuDu

Tiêu đề lớn dùng **PhuDu** — font Việt của nhà thiết kế **Dương Trần**, lấy cảm hứng từ **chữ viết tay trên biển hiệu Việt Nam xưa**. Đây là lựa chọn ngược khuyến nghị "an toàn" của nghiên cứu (Be Vietnam Pro), và người sáng lập chọn có lý do: giữa thị trường edtech toàn Inter/Nunito na ná nhau, **hero mang hồn chữ Việt là thứ khác biệt ngay từ cái nhìn đầu tiên** — cộng hưởng với câu chuyện "thương hiệu Việt cho phụ huynh Việt".

Một hiểu nhầm cần gỡ: **font Việt không phải font chỉ dùng cho tiếng Việt.** Bảng chữ tiếng Việt là Latin + dấu, nên PhuDu chứa trọn bộ chữ tiếng Anh với cùng phong cách. Câu "A little brighter every day" viết bằng PhuDu vẫn mang đúng hồn biển hiệu đó → **một font cho cả hai ngôn ngữ**, không cần cơ chế đổi font theo locale.

Phần còn lại: **Be Vietnam Pro** (font do người Việt thiết kế, dấu vẽ đúng từ gốc) cho tiêu đề thường và đoạn văn dài; **Inter** cho giao diện và số liệu; **Lexend** cho khung chat học sinh (font duy nhất có nghiên cứu RCT về khả năng đọc trên 2.684 học sinh).

---

## 6. Logo: mọi chi tiết đều có lý do

Wordmark **RANGI** chữ hoa, font PhuDu 700, với ba quyết định thiết kế do người sáng lập chỉ đạo qua ba vòng tinh chỉnh:

1. **Chữ I rút ngắn còn ~42% chiều cao chữ hoa** — để chấm sáng + quầng nằm gọn trong khối chữ, đỉnh quầng ngang đỉnh chữ G. Trước khi sửa, chấm sáng lơ lửng phía trên trông như vật thể bay, không thuộc về con chữ.
2. **Khe trước chữ I rộng hơn số học ~9% cỡ chữ** — vì chữ I là nét mảnh, đặt cách đều y hệt các chữ khác thì **mắt thấy chật**. Đây là căn quang học, nguyên tắc kinh điển của nghề chữ.
3. **Chấm chữ i = mascot** — không phải dấu chấm.

Hệ quả kiến trúc: toàn bộ 15 file SVG được **sinh ra từ code** (`scripts/brand/generate-logo.mjs`), không phải vẽ tay. Muốn đổi thì sửa tham số rồi chạy lại — logo, icon, lockup, ảnh chia sẻ mạng xã hội tự cập nhật đồng bộ, không bao giờ lệch nhau.

---

## 7. Triết lý và slogan
...
Triết lý này **chi phối sản phẩm**, không chỉ là lời hay: vì thế mới không có bảng xếp hạng; vì thế báo cáo mới hiển thị "so với hôm qua" thay vì "% so với chuẩn"; vì thế sprint mới chia thành nhiệm vụ nhỏ mỗi tối thay vì lộ trình dài mông lung.

Hòa cùng điển tích **"ngọc bất trác bất thành khí"** từ màu sắc: con là ngọc, học là mài giũa, mài mỗi ngày một chút.
...
## 9. Giọng thương hiệu (brand voice)

1. **Trung thực về giới hạn** — luôn nói "mức sẵn sàng", không hứa tuyệt đối. Đây vừa là đạo đức vừa là ràng buộc pháp lý.
2. **Ấm như người đồng hành, không như giáo viên chấm điểm** — xưng "ba mẹ" chứ không "quý khách hàng"; báo cáo kể chuyện tiến bộ theo mạch, không liệt kê lỗi như bảng điểm.
3. **Thông báo trung lập tuyệt đối** (yêu cầu pháp lý, nghiêm ngặt nhất với push notification) — chỉ nêu sự kiện + gợi ý nhẹ; không hối thúc, không so sánh, không "con đang tụt lại".
4. **Minh bạch AI** — không đóng vai người thật, không đặt tên cô giáo giả.
5. **Cụ thể hơn hoa mỹ** — "con đã hoàn thành 4/5 dạng bài phân số" thay vì "con học rất tốt!". Ẩn dụ ánh sáng chỉ sống ở tầng câu chuyện thương hiệu và landing page, **không đưa vào báo cáo tuần** (phụ huynh cần đọc nhanh, hiểu ngay).

---

## 10. Ngôn ngữ cấm (bất biến)
