...
- [ ] **Xem xét hướng "logo mềm" cho wordmark** — đánh giá 05/08/2026: nhận xét "PhuDu 700 uppercase quá cứng cho edtech trẻ em" có cơ sở; mẫu tham chiếu (rounded lowercase, đuôi g thành nét bay, chuỗi chấm to dần) tái dùng đúng motif đã chốt nên tương thích câu chuyện thương hiệu; NHƯNG đổi wordmark = mở lại quyết định đã chốt → cần vòng nghiên cứu ngắn (ứng viên font rounded có vietnamese subset: Quicksand/Baloo 2 — bắt buộc test dấu, bài học Nunito; không lấy hex palette của mẫu). Chi phí kỹ thuật thấp nhờ wordmark sinh từ code. Phân tích: `docs/research/danh-gia-tham-my-mascot-icon-2026-08-05.md` mục "logo mềm"; ảnh mẫu chờ người dùng kéo vào `docs/brand/refs/` (agent không lưu được file ảnh từ hội thoại) (CẢ HAI)
- [ ] **Làm lại thẩm mỹ mascot + icon (spec mới, sau khi gói SVG hiện tại merge)** — người dùng đánh giá bản vẽ 05/08/2026 xấu so với mẫu tham chiếu; nguyên nhân gốc đã phân tích (ràng buộc flat-only do kiến trúc sư đặt chặn gradient/blur; filled dẫn xuất cơ học từ outline; vòng lặp thiếu thước đo thẩm mỹ so mẫu). Hướng đề xuất: nới ràng buộc gradient/stop-opacity trong whitelist màu, dựng lại silhouette mascot bằng bezier liền + glow gradient, icon filled vẽ lại theo ngữ pháp filled, cân nhắc restyle bộ mã nguồn mở (Lucide, ISC) thay vì tự vẽ 21 hình. Phân tích đầy đủ: `docs/research/danh-gia-tham-my-mascot-icon-2026-08-05.md` (CẢ HAI)
